    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            {/* No GitHub link: the account holding the repo is shadow-flagged,
                ...
                LinkedIn carries the required public-presence signal instead. */}
            <div className="footer-social">
              <a href="https://www.linkedin.com/company/raidar1" target="_blank" rel="noreferrer" aria-label="LinkedIn"><Linkedin size={17} /></a>
              <a href="https://discord.gg/raidar" target="_blank" rel="noreferrer" aria-label="Discord"><MessageCircle size={17} /></a>
              <a href="mailto:info@raidar.tech" aria-label="Email"><Mail size={17} /></a>
            </div>
          </div>
          ...
          <div className="footer-col">
            ...
            <a href="https://www.linkedin.com/company/raidar1" target="_blank" rel="noreferrer">LinkedIn</a>
            <Link to="/security">Security</Link>
            <Link to="/status">System status</Link>
            <Link to="/blog">Blog &amp; news</Link>
            <a href="mailto:info@raidar.tech">Support</a>
          </div>
        ...
        <div className="footer-partners">
          <div className="footer-partners-group">
            <span className="footer-partners-label">Backed by</span>
          ...
          {/* Braintrust is factual attribution, NOT a partnership claim.
              Braintrust publishes no brand/trademark page (verified 404s on
              /brand, /press, /trademark), so there is no documented permission
              to assert endorsement — "Built with" states only what we use. */}
          <div className="footer-partners-group">
            <span className="footer-partners-label">Built with</span>
            <div className="footer-partners-row">
              <a
                className="footer-partner"
