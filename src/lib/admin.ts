...
export interface SubUser { name: string; email: string; }
...
export const bootstrap = (search = '') => adminCall<{ total: number; users: AdminUser[]; stats: AdminStats; subUsers: Record<string, SubUser | null> }>('bootstrap', { search });
