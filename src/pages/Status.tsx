...
// SHA-256 of the current signed Windows installer (Raidar_1.0.5_x64-setup.exe).
// Update this whenever a new release is published so the scan links stay accurate.
const INSTALLER_SHA256 = 'bc3731106508a843a4dc98d2f68e2f557142b7afa71af50d12ec77da639640fe';
...
export default function Status() {
  ...
  const [latestVersion, setLatestVersion] = useState<string>('v1.0.5');
